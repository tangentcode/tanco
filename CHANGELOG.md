...
- **Error handling for missing test files**: Better error messages when test files or tests are not found.
- **Optional restart configuration**: `restart-cmd` and `restart-expect` strings in config.
